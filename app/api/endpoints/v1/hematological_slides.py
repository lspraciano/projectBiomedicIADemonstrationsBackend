...
from app.core.dependencies.ml_models_loader import wbc_yolo_model_to_detection
...
async def hematological_slides_predict_(
        image: Image = Depends(open_valid_image_file),
        wbc_yolo_model: YOLO = Depends(wbc_yolo_model_to_detection)
):
    """
    **Hematological Slides Predict**

    This route performs detections of white blood cells in a hematological slide image.
    """
